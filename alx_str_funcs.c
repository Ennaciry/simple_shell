...
/**
 * alx_strchr - Locates a character in a string.
...
/**
 * alx_strspn - Gets the length of a prefix substring.
 * @s: The string to be searched.
...
/**
 * alx_strcmp - Compares two strings.
...
/**
 * alx_strncmp - Compare two strings.
